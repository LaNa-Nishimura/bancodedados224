...
namespace Aviacao.Controllers
{
    ...
    {
        private readonly AviacaoContext _context;

        public VoosController(AviacaoContext context)
        {
            _context = context;
        }
        ...
        {
            var aviacaoContext = _context.Voos.Include(v => v.IdAeronaveNavigation).Include(v => v.IdAeroportoDestinoNavigation).Include(v => v.IdAeroportoSaidaNavigation);
            return View(await aviacaoContext.ToListAsync());
        }
